...
//! (`call_raw`) using `knot-registry` for membership/threshold.
//!
//! Signed message is the §4a digest from `knot-encoding`. See README.md.
...
extern crate alloc;
extern crate self as knot_proposals;
